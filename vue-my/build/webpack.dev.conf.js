'use strict'
// 工具类方法 // 首先引入的是一些工具方法，下面我们就需要去util文件种看一下有哪些对应的工具方法
const utils = require('./utils')
//webpack工具类  引入webpack模块
const webpack = require('webpack')
// 配置文件 
// 引入配置文件
// 这个配置文件中包含了一些dev和production环境的基本配置
const config = require('../config')
// 使用webpack配置合并插件 // 引入webpack-merge模块。这个模块用于把多个webpack配置合并成一个配置，后面的配置会覆盖前面的配置
const merge = require('webpack-merge')
// 路径配置
const path = require('path')
// 基础配置 引入webpack的基本设置，这个设置文件包含了开发环境和生产环境的一些公共配置
const baseWebpackConfig = require('./webpack.base.conf')

const CopyWebpackPlugin = require('copy-webpack-plugin')
// 这个插件自动生成HTML，并注入到.html文件中 用于生成html文件的插件
...
// webpack.dev.conf.js与webpack.base.conf.js中的配置合并 // 开发环境的完整的配置文件，
